...
<!-- setting out the header -->
    <header id="header" class="jumbotron text-center ">
        ...
        if (!isset($_COOKIE['userID'])) {
            ...
            <p style="color:azure">You were last logged in at <span id="logindata"><?php echo  $_SESSION['logintime']; ?></span></p>
        ...
        <div id="headerAttribution">
            ...
            Photo by Pixabay</a> from <a href="https://www.pexels.com/photo/art-background-blue-design-268415">Pixabay</a>
        </div>
    </header>